const packageDetails = {
    "Family Tour Packages": {
        ...
        description: `
            <p><strong>Family Paradise: Multi-Generation Goa Experience</strong></p>
...
Our Family Paradise package transforms Goa into a natural playground where multiple generations can connect through shared experiences while still having space for age-appropriate activities. We've carefully balanced beach time, cultural exploration, nature adventures, and relaxation to create the perfect family rhythm.</p>
    ...
    "Beach Camping Experiences": {
        ...
        description: `
            <p><strong>Starlit Shores: Premium Beach Camping Adventure</strong></p>
...
Camp at iconic locations like Arambol Beach, known for its bohemian spirit and spectacular sunsets, or the more secluded Cola Beach with its freshwater lagoon. For those seeking true escape, we offer exclusive access to lesser-known gems like Butterfly Beach and portions of Galgibaga Beach, where Olive Ridley turtles sometimes nest (seasonal).</p>
 <h3>What Makes This Experience Special:</h3>
    ...
    "Honeymoon Packages": {
        ...
        description: `
            <p><strong>Romance in Paradise: Curated Goa Honeymoon Experience</strong></p>
    ...
    "Yoga Packages": {
        title: "Yoga Packages",
        description: `
        <p><strong>Inner Goa: Transformative Yoga & Wellness Retreat</strong></p>
    ...
    "Nature Packages": {
        ...
        description: `
            <p><strong>Wild Goa: Biodiversity & Ecotourism Expedition</strong></p>
    ...
    "Group Packages": {
        ...
        description: `
                <p><strong>Goa Tribe: Ultimate Group Adventure Package</strong></p>
    ...
    "Trekking Packages": {
        ...
        description: `
                    <p><strong>Goa Wilderness Explorer: Western Ghats Trekking Adventure</strong></p>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const popupContent = popup.querySelector('.service-popup__content');
    const closeBtn = document.querySelector('.service-popup__close');
    const mainContent = document.querySelectorAll('.page-wrapper > *:not(#servicePopup)');
    ...
    function closePopup() {
        ...
        setTimeout(() => {
            ...
            // Reset the content state for next opening
            popupContent.style.transform = 'scale(0.7)';
            popupContent.style.opacity = '0';
        }, 300);
    }
    ...
    document.querySelectorAll('.services-one__title, .services-one__read-more').forEach(element => {
        element.addEventListener('click', function(e) {
            e.preventDefault();
            const serviceTitle = this.closest('.services-one__single')
                                   .querySelector('.services-one__title')
                                   .textContent.trim();
            
            if (packageDetails[serviceTitle]) {
                document.querySelector('.service-popup__title').textContent = packageDetails[serviceTitle].title;
                document.querySelector('.service-popup__description').innerHTML = packageDetails[serviceTitle].description;
                openPopup();
            }
        });
    });
